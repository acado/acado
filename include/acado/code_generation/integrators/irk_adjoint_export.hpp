...
/**
 *    \file include/acado/code_generation/integrators/irk_adjoint_export.hpp
 *    \author Rien Quirynen
 *    \date 2013
 */


#ifndef ACADO_TOOLKIT_IRK_ADJOINT_EXPORT_HPP
#define ACADO_TOOLKIT_IRK_ADJOINT_EXPORT_HPP
...
/** 
 *	\brief Allows to export a tailored implicit Runge-Kutta integrator with adjoint sensitivity generation for fast model predictive control.
 *
 *	\ingroup NumericalAlgorithms
 *
 *	The class AdjointIRKExport allows to export a tailored implicit Runge-Kutta integrator
 *	with backward sensitivity generation for fast model predictive control.
 *
 *	\author Rien Quirynen
 */
class AdjointIRKExport : public ImplicitRungeKuttaExport, public RKSensitivitiesExport
{
    //
    ...
    public:
		 ...
		 */
        AdjointIRKExport(	UserInteraction* _userInteraction = 0,
		 ...
		 */
        AdjointIRKExport(	const AdjointIRKExport& arg
							);

        /** Destructor. 
		 */
        virtual ~AdjointIRKExport( );
		 ...
		 *	@param[in] arg		Right-hand side object.
		 */
		AdjointIRKExport& operator=(	const AdjointIRKExport& arg
										);
...
#endif  // ACADO_TOOLKIT_IRK_ADJOINT_EXPORT_HPP
