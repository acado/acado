...
// 							);
		 ...
		 */
        ExportArgument(	const ExportArgument& arg
						);

		/** Destructor. 
		 */
		virtual ~ExportArgument( );

		/** Assignment operator (deep copy).
		 *
		 *	@param[in] arg		Right-hand side object.
		 */
		ExportArgument& operator=(	const ExportArgument& arg
									);
		 ...
		 *	@param[in] arg		Right-hand side object.
		 */
		ExportArgument& operator=(	const Matrix& arg
									);
		...
		/** Initializes argument with given name, type and dimensions.
		 *
		 *	@param[in] _name			Name of the argument.
		 *	@param[in] _nRows			Number of rows of the argument.
		 *	@param[in] _nCols			Number of columns of the argument.
		 ...
		 */
		ExportArgument getAddress(	uint rowIdx,
									uint colIdx = 0
									) const;

		/** Returns a copy of the argument with address index set to given location.
		 *
		 *	@param[in] rowIdx		Variable row index of the adress.
		 *	@param[in] colIdx		Column index of the adress.
		 *
		 *	\return Copy of the argument with address index set to given location
		 */
		 ...
		 */
		const char* getAddressString(	BooleanType withDataStruct = BT_TRUE
										) const;
	...
	protected:
		...
		/** Frees internal dynamic memory to yield an empty argument.
		 *
		 *	\return SUCCESSFUL_RETURN
		 */
		returnValue clear( );
