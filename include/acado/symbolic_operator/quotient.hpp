...
public:
    ...
    /** Default constructor. */
    Quotient( const SharedOperator &_argument1, const SharedOperator &_argument2 );
...
protected:
    ...
    SharedOperator derivative0;		/**< An auxiliary variable to define the quotient. */
    SharedOperator derivative1;		/**< An auxiliary variable to define the first order derivative of the quotient. */
    SharedOperator derivative2;		/**< An auxiliary variable to define the second order derivative of the quotient. */
