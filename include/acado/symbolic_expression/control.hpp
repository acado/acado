...
/**
*    \file include/acado/symbolic_expression/control.hpp
*    \author Boris Houska, Hans Joachim Ferreau
*    \date 2008
*/


#ifndef ACADO_TOOLKIT_CONTROL_HPP
#define ACADO_TOOLKIT_CONTROL_HPP
...
/**
 *	\brief Implements a control variable.
 *
 *	\ingroup BasicDataStructures
 *
 *	The class Control implements a control variable within the 
