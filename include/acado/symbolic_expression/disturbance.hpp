...
/**
*    \file include/acado/symbolic_expression/disturbance.hpp
*    \author Boris Houska, Hans Joachim Ferreau
*    \date 2008
*/


#ifndef ACADO_TOOLKIT_DISTURBANCE_HPP
#define ACADO_TOOLKIT_DISTURBANCE_HPP
...
/**
 *	\brief Implements a disturbance variable.
 *
 *	\ingroup BasicDataStructures
 *
 *	The class Disturbance implements a disturbance variable within the 
 *	family of Expressions.
 *
 *	\author Boris Houska, Hans Joachim Ferreau
 */

class Disturbance : public Expression{
...
public:
    ...
    Disturbance& operator=( const Disturbance &arg );
