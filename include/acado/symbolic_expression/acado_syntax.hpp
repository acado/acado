...
/** \name Standard math operators for matrix valued expressions.
 *  @{
 */

const REFER_NAMESPACE_ACADO Expression sin ( const REFER_NAMESPACE_ACADO Expression &arg );
const REFER_NAMESPACE_ACADO Expression cos ( const REFER_NAMESPACE_ACADO Expression &arg );
const REFER_NAMESPACE_ACADO Expression tan ( const REFER_NAMESPACE_ACADO Expression &arg );
const REFER_NAMESPACE_ACADO Expression asin( const REFER_NAMESPACE_ACADO Expression &arg );
const REFER_NAMESPACE_ACADO Expression acos( const REFER_NAMESPACE_ACADO Expression &arg );
const REFER_NAMESPACE_ACADO Expression atan( const REFER_NAMESPACE_ACADO Expression &arg );
const REFER_NAMESPACE_ACADO Expression exp ( const REFER_NAMESPACE_ACADO Expression &arg );
const REFER_NAMESPACE_ACADO Expression sqrt( const REFER_NAMESPACE_ACADO Expression &arg );
const REFER_NAMESPACE_ACADO Expression ln  ( const REFER_NAMESPACE_ACADO Expression &arg );
const REFER_NAMESPACE_ACADO Expression log ( const REFER_NAMESPACE_ACADO Expression &arg );

const REFER_NAMESPACE_ACADO Expression pow ( const REFER_NAMESPACE_ACADO Expression &arg1,
...
REFER_NAMESPACE_ACADO Expression getRiccatiODE( const REFER_NAMESPACE_ACADO Expression &rhs ,
                                                ...
                                                const REFER_NAMESPACE_ACADO Expression &u   ,
                                                const REFER_NAMESPACE_ACADO Expression &P   ,
                                                const REFER_NAMESPACE_ACADO Expression &Q   ,
                                                const REFER_NAMESPACE_ACADO Expression &Rinv );
