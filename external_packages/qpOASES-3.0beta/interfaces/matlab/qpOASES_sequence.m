...
%                    qpOASES_sequence( 'i',H,g,A,lb,ub,lbA,ubA,{x0,{options}} )
...
%II) Call
%     [x,fval,exitflag,iter,lambda] = ...
%                     qpOASES_sequence( 'h',g,lb,ub,lbA,ubA,{options} )
...
%
%
%See also QPOASES_OPTIONS, QPOASES_SEQUENCESB, QPOASES_SEQUENCEVM
%
%
