...
class SparseMatrix : public virtual Matrix
{
	public:
		...
		SparseMatrix(
				...
				long *r, 		/**< Row indices (length). */
				long *c, 		/**< Indices to first entry of columns (nCols+1). */
				real_t *v,		/**< Vector of entries (length). */
				long *d = 0		/**< Indices to first entry of lower triangle (including diagonal) (nCols). */
				);
	...
	protected:
		...
		long *ir;			/**< Row indices (length). */
		long *jc;			/**< Indices to first entry of columns (nCols+1). */
		long *jd;			/**< Indices to first entry of lower triangle (including diagonal) (nCols). */
