 ...
 */
 ...
 /**
  *    \file   examples/multi_objective/car_ws.cpp
  *    \author Filip Logist, Boris Houska, Hans Joachim Ferreau
  *    \date   2009
  *
  *    Weighted Sum for a car example with conflicting time and energy cost
  *    J = (1-W)*J1+W*J2
...
int main( ){
    ...
    algorithm.getWeights("car_ws_weights.txt");
    algorithm.getAllDifferentialStates("car_ws_states.txt");
    algorithm.getAllControls("car_ws_controls.txt");
    algorithm.getAllParameters("car_ws_parameters.txt");
    ...
    // SAVE INFORMATION:
    // -----------------
    paretoFront.print( "car_ws_pareto.txt" );
