 ...
 */
 ...
 /**   
  *    \file   examples/multi_objective/plug_flow_reactor2_nnc.cpp
...
int main( ){
    ...
    algorithm.getWeights("plug_flow_reactor2_nnc_weights.txt");
    algorithm.getAllDifferentialStates("plug_flow_reactor2_nnc_states.txt");
    algorithm.getAllControls("plug_flow_reactor2_nnc_controls.txt");
    ...
    // SAVE INFORMATION:
    // -----------------
    FILE *file = fopen("plug_flow_reactor2_nnc_pareto.txt","w");
    paretoFront.print();
    file << paretoFront;
    fclose(file);
