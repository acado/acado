 ...
 */
 ...
 /**   
  *    \file   examples/multi_objective/fed_batch_bioreactor_nnc.cpp
  *    \author Filip Logist, Boris Houska, Hans Joachim Ferreau
  *    \date   2009
  *
  *    \  Normal Boundary Intersection method for a fed-batch bioreactor with yield-productivity conflict
