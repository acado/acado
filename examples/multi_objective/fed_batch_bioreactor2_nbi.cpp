 ...
 */
 ...
 /**   
  *    \file   examples/multi_objective/fed_batch_bioreactor2_nbi.cpp
  *    \author Filip Logist, Boris Houska, Hans Joachim Ferreau
  *    \date   2009
  *
  *    \  Normal boundary intersection for a fed-batch bioreactor with yield-productivity conflict
...
int main( ){
    ...
    // SAVE INFORMATION:
    // -----------------
    FILE *file = fopen("fed_batch_bioreactor2_nbi_pareto.txt","w");
    paretoFront.print();
    file << paretoFront;
    fclose(file);
