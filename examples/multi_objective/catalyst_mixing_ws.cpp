 ...
 */
 ...
 /**   
  *    \file   examples/multi_objective/catalyst_mixing_ws.cpp
...
int main( ){
    ...
    // DEFINE AN MULTI-OBJECTIVE ALGORITHM AND SOLVE THE OCP:
    // --------------------------------------------------------
    ...
    algorithm.getWeights("catatlyst_mixing_ws_weights.txt");
    algorithm.getAllDifferentialStates("catalyst_mixing_ws_states.txt");
    algorithm.getAllControls("catalyst_mixing_ws_controls.txt");
    ...
    // SAVE INFORMATION:
    // -----------------
    paretoFront.print( "catalyst_mixing_ws_pareto.txt" );
