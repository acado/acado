...
%%
%%    \file interfaces/matlab/models/harmonic_oscillator.m
...
%%
 ...
 %  -----------------------------
    settings.Model = 'harmonic_oscillator';  % This file should also be included in ../../MODEL_INCLUDE.m
 ...
 %  ------------------------------------------------------------
    settings.Tolerance         = 1e-5;     % relative tolerance.
    settings.AbsoluteTolerance = 1e-5;     % absolute tolerance.
