...
%%
%%    \file interfaces/matlab/models/getting_started_discretized.m
...
%%
 ...
 %  -----------------------------
    settings.Model = 'getting_started_discretized';        % This file should also be included in ../../MODEL_INCLUDE.m
 ...
 %  ----------------------------------------------------
   ...
   settings.Integrator = 'DiscretizedODE';
