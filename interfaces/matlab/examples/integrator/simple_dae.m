...
%%
%%    \file interfaces/matlab/examples/integrator/simple_dae.m
...
%%
 ...
 %  -----------------------------
    settings.Model = 'simple_dae';             % C++ -> Using simple_dae.cpp   % This file should also be included in ../../MODEL_INCLUDE.m
    % settings.Model = { @simple_dae_matlab };   % Matlab -> Using simple_dae_matlab.m
 ...
 %  ------------------------
    xStart  = [ 1.0 ]';             % This model has one differential state
    xaStart = [ 1.0 ]';             % This model has one algebraic state
