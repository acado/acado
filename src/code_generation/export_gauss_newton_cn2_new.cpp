...
/**
 *    \file src/code_generation/export_gauss_newton_cn2_new.cpp
...
ExportGaussNewtonCN2New::ExportGaussNewtonCN2New(	UserInteraction* _userInteraction,
...
returnValue ExportGaussNewtonCN2New::getDataDeclarations(	ExportStatementBlock& declarations,
...
returnValue ExportGaussNewtonCN2New::getFunctionDeclarations(	ExportStatementBlock& declarations
															) const
{
...
returnValue ExportGaussNewtonCN2New::getCode(	ExportStatementBlock& code
											)
{
	setupQPInterface();
...
unsigned ExportGaussNewtonCN2New::getNumQPvars( ) const
{
	if (performFullCondensing() == true)
		return (N * NU);
...
unsigned ExportGaussNewtonCN2New::getNumStateBounds() const
{
...
returnValue ExportGaussNewtonCN2New::setupObjectiveEvaluation( void )
{
...
returnValue ExportGaussNewtonCN2New::setupConstraintsEvaluation( void )
{
...
returnValue ExportGaussNewtonCN2New::setupVariables( )
{
	////////////////////////////////////////////////////////////////////////////
	//
...
returnValue ExportGaussNewtonCN2New::setupMultiplicationRoutines( )
{
...
returnValue ExportGaussNewtonCN2New::setupEvaluation( )
{
	////////////////////////////////////////////////////////////////////////////
	//
	// Preparation phase
...
returnValue ExportGaussNewtonCN2New::setupQPInterface( )
{
	string folderName;
...
bool ExportGaussNewtonCN2New::performFullCondensing() const
{
