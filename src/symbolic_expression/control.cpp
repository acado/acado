...
/**
*    \file src/symbolic_expression/control.cpp
...
Control::Control( const Control &arg )
               :Expression(arg){ }
...
Control& Control::operator=( const Control &arg ){
...
Expression* Control::clone() const{

    return new Control(*this);
}


returnValue Control::clearStaticCounters(){
